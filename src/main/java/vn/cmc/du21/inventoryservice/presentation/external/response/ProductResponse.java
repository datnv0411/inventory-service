...
public class ProductResponse {
    ...
    public ProductResponse(long productId, String productName, String productSearch, String quantitative, String description, String createTime, String productImage, long categoryId, List<SizeResponse> sizeResponseList) {
        this.productId = productId;
        this.productName = productName;
        this.productSearch = productSearch;
        this.quantitative = quantitative;
