...
public class ProductMapper {
    public static ProductResponse convertProductToProductResponse(Product product)
    {
        ...
        return new ProductResponse(product.getProductId(),product.getProductName(), product.getProductSearch(), product.getQuantitative()
                , product.getDescription(), createTime, product.getProductImage(), product.getCategory().getCategoryId());
    }
}
