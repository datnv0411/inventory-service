...
//        int sizeInt = Integer.parseInt(size);
        ...
        Page<ProductResponse> listProduct = productService.getProductByName(name, page, size, sort)
                .map(ProductMapper::convertProductToProductResponse);
...
//        if(sort == null || sort.equals("")) sort = "productId";
        ...
        Page<ProductResponse> listProduct = productService.getProductByCategory(category, page, size, sort).map(ProductMapper::convertProductToProductResponse);
        return ResponseEntity.status(HttpStatus.OK).body(
                new PageResponse<Object>(
                        StatusResponse.SUCCESSFUL
                        , "successfully"
